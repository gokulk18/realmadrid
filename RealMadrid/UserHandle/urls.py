...
urlpatterns = [
    ...
    path('verify-ticket-payment/<str:order_number>/', views.verify_ticket_payment, name='verify_ticket_payment'),
    path('process-ticket-payment/<str:order_number>/', views.process_ticket_payment, name='process_ticket_payment'),
